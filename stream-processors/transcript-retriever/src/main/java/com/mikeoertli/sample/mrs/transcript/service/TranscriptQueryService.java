...
import static com.mikeoertli.sample.mrs.model.Constants.TRANSCRIPT_BODY_KEY;
import static org.elasticsearch.index.query.QueryBuilders.matchQuery;

/**
 * Fetches a transcript for various types of media from Elasticsearch database.
...
public class TranscriptQueryService
{
    ...
    @Autowired
    public TranscriptQueryService(ITranscriptElasticRepository transcriptRepository, ElasticsearchOperations searchTemplate)
    {
    ...
    public Optional<TranscriptWrapper> getTranscriptForPodcast(int episodeNum)
    {
        Query searchQuery = new NativeSearchQueryBuilder()
                .withQuery(matchQuery(Constants.EPISODE_NUMBER, episodeNum))
                .build();
