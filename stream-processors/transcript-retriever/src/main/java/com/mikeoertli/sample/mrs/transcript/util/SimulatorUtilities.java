...
import static com.mikeoertli.sample.mrs.model.Constants.AUTHOR_KEY;
import static com.mikeoertli.sample.mrs.model.Constants.MEDIA_TYPES;
import static com.mikeoertli.sample.mrs.model.Constants.MEDIA_TYPE_KEY;
import static com.mikeoertli.sample.mrs.model.Constants.PUBLICATION_DATE_KEY;
import static com.mikeoertli.sample.mrs.model.Constants.PUBLISHER_KEY;
import static com.mikeoertli.sample.mrs.model.Constants.TITLE_KEY;
import static com.mikeoertli.sample.mrs.model.Constants.URL_KEY;
...
public class SimulatorUtilities
{
    ...
    {
        Map<String, Object> metadata = createRandomMetadata(null);
        metadata.put(Constants.EPISODE_NUMBER, episodeNum);
        metadata.put(MEDIA_TYPE_KEY, Constants.PODCAST_TYPE);
