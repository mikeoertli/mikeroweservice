...
import com.mikeoertli.sample.mrs.graphql.generated.types.TelevisionEpisode;
...
public class TelevisionEpisodeDatafetcher
{
    ...
    @Autowired
    public TelevisionEpisodeDatafetcher(KafkaQueryService queryService)
    {
        this.queryService = queryService;
    }

    @DgsQuery
    public TelevisionEpisode televisionEpisode(@InputArgument String showName, @InputArgument Integer seasonNumber, @InputArgument Integer episodeNumber)
    {
        return null;
    }
}
