...
public class MostPopularSocialMediaPostSinceDatafetcher
{
    ...
    @Autowired
    public MostPopularSocialMediaPostSinceDatafetcher(KafkaQueryService queryService)
    {
        this.queryService = queryService;
    }

    @DgsQuery
    public ISocialMediaPost mostPopularSocialMediaPostSince(@InputArgument Integer numDays)
    {
        return null;
    }
}
