...
import com.mikeoertli.sample.mrs.graphql.model.types.Movie;
...
public class MostPopularMoviesDatafetcher
{
    ...
    @DgsData(parentType = DgsConstants.QUERY_TYPE, field = DgsConstants.QUERY.MostPopularMovies)
    public List<Movie> getMostPopularMovies(DataFetchingEnvironment dataFetchingEnvironment)
    {
        return null;
    }
}
