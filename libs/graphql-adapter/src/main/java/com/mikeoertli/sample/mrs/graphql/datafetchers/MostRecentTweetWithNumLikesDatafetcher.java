...
@DgsComponent
public class MostRecentTweetWithNumLikesDatafetcher
{
    ...
    @DgsData(parentType = DgsConstants.QUERY_TYPE, field = DgsConstants.QUERY.MostRecentTweetWithNumLikes)
    public SocialMediaPost getMostRecentTweetWithNumLikes(DataFetchingEnvironment dataFetchingEnvironment)
    {
        return null;
    }
}
