...
public class MostPopularTweetSinceDatafetcher
{
    ...
    @DgsData(parentType = DgsConstants.QUERY_TYPE, field = DgsConstants.QUERY.MostPopularTweetSince)
    public SocialMediaPost getMostPopularTweetSince(DataFetchingEnvironment dataFetchingEnvironment)
    {
        return null;
    }
}
