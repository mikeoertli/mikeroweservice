...
@DgsComponent
public class TelevisionTranscriptDatafetcher
{
    ...
    @DgsData(parentType = DgsConstants.QUERY_TYPE, field = DgsConstants.QUERY.TelevisionTranscript)
    public Transcript getTelevisionTranscript(DataFetchingEnvironment dataFetchingEnvironment)
    {
        return null;
    }
}
