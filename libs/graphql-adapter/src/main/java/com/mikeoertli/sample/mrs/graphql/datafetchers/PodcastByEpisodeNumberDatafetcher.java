...
public class PodcastByEpisodeNumberDatafetcher
{
    ...
    @DgsData(parentType = DgsConstants.QUERY_TYPE, field = DgsConstants.QUERY.PodcastByEpisodeNumber)
    public PodcastEpisode getPodcastByEpisodeNumber(DataFetchingEnvironment dataFetchingEnvironment)
    {
        return null;
    }
}
