...
@DgsComponent
public class MostPopularTelevisionEpisodeDatafetcher
{
    ...
    @DgsData(parentType = DgsConstants.QUERY_TYPE, field = DgsConstants.QUERY.MostPopularTelevisionEpisode)
    public TelevisionEpisode getMostPopularTelevisionEpisode(DataFetchingEnvironment dataFetchingEnvironment)
    {
        return null;
    }
}
